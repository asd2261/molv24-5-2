...
!function(){
    ...
    function i() {
        ...
        s.forEach(function(i, x) {
            ...
            r.fillRect(i.x - 1, i.y - 1, 2, 2), e = x + 1; e < u.length; e++) n = u[e], 
            null !== n.x && null !== n.y && (o = i.x - n.x, m = i.y - n.y,
            l = o * o + m * m, l < n.max && (n === y && l >= n.max / 2 && (i.x -= .03 * o, i.y -= .03 * m),
            t = (n.max - l) / n.max, r.beginPath(), r.lineWidth = t * 3, 
            r.strokeStyle = "#909dfc", r.moveTo(i.x, i.y), r.lineTo(n.x, n.y), r.stroke()));
        }),
        x(i);
    }
    var a, c, u, m = document.createElement("canvas"),
        ...
        w = Math.random, y = { x: null, y: null, max: 3e4 };
    ...
    for (var s = [], f = 0; d.n > f; f++) {
        ...
        s.push({ x: h, y: g, xa: v, ya: p, max: 8e3 });
    }
